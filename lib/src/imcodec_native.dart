...
abstract final class ImcodecNative {
  ...
  ///
  /// AVIF and HEIF add formats, while JPEG XL and WebP replace Imcodec's Dart
  /// codecs. All four registrations provide native decoding and encoding.
  ...
  static void register({
    ...
    final List<bool> enabled = [avif, heif, jpegXl, webP];
